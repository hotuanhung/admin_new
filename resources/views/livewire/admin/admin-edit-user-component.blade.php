            ...
            <div class="mt-5">
                ...
                <form wire:submit.prevent="submit" class="items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0" >
                    ...
                    <div class="w-full mt-3 xl:mt-0 flex-1">
                        <input id="product-name" type="text" class="form-control" placeholder="{{ $user->firstname }}" wire:model="firstname">
                    ...
                    <div class="w-full mt-3 xl:mt-0 flex-1">
                        <input id="product-name" type="text" class="form-control" placeholder="{{ $user->lastname}}" wire:model="lastname">
                        <div class="form-help text-right">Maximum character : 255</div>
                    </div>
                     <!--Gender-->
                     <div class="form-label ">
                    ...
                    <div class="w-full mt-3 xl:mt-0 flex-1">
                        <input id="product-name" type="text" class="form-control" placeholder="{{ $user->email }}" wire:model="email">
                        <div class="form-help text-right">Maximum character : 255</div>
                    </div>
                    ...
                    <div class="w-full mt-3 xl:mt-0 flex-1">
                        <input id="product-name" type="text" class="form-control" placeholder="{{ $user->password }}" wire:model="password">
                        <div class="form-help text-right">Maximum character : 255</div>
                    </div>
                    ...
                    <div class="w-full mt-3 xl:mt-0 flex-1">
                        <textarea id="product-name" type="text" class="form-control" placeholder="{{ $user->address}}" wire:model="address"></textarea>
