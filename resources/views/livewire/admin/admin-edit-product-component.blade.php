                ...
                <div class="border border-slate-200/60 dark:border-darkmode-400 rounded-md p-5">
                    ...
                    <div class="mt-5">
                        ...
                        <form wire:submit.prevent="submit" class="items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0" >
                            ...
                            <div class="w-full mt-3 xl:mt-0 flex-1">
                                <input id="product-name" type="text" class="form-control" placeholder="{{ $product->quantity }}" wire:model.lazy="quantity">
                            ...
                            <div class="w-full mt-3 xl:mt-0 flex-1">
                                <div class="sm:grid grid-cols-4 gap-2">
                                    <div class="input-group w-full">
                                        ...
                                        <input type="text" class="form-control mt-3 sm:mt-0 " placeholder="{{ $product->price }}" wire:model.lazy="price">
                                        <input type="text" class="form-control mt-3 sm:mt-0" placeholder="{{ $product->discount_price }} " wire:model.lazy="discount_price">
                                    </div>  
