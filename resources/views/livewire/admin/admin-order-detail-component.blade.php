...
<div class="intro-y grid grid-cols-11 gap-5 mt-5">
    <div class="col-span-12 lg:col-span-4 2xl:col-span-3">
        ...
        <div class="box p-5 rounded-md mt-5">
            ...
            <div class="flex items-center">
                <i data-lucide="clipboard" class="w-4 h-4 text-slate-500 mr-2"></i> Payment Method: <div class="ml-auto">{{ $order->payment }}</div>
            </div>
            <div class="flex items-center mt-3">
            ...
            <div class="flex items-center mt-3">
                <i data-lucide="credit-card" class="w-4 h-4 text-slate-500 mr-2"></i> Discount: <div class="ml-auto">{{ $order->coupon->coupon_code }} {{ $order->coupon->discount }}%</div>
            </div>
            <div class="flex items-center mt-3">
                            ...
                            <tr>
                                <td class="!py-4">
                                    <div class="flex items-center">
                                        ...
                                        <a href="" class="font-medium whitespace-nowrap ml-4">{{ $ot->name }}</a>
                                    </div>
                                </td>
